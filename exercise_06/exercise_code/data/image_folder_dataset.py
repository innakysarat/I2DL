...
class GaussianBlur:
    def __init__(self, radius):
        """
        Initializes the GaussianBlur class with a given radius.
    ...
    def __call__(self, image):
        ...
        blurred_image = pil_image.filter(ImageFilter.GaussianBlur(self.radius))
...
class Rotation:
    def __init__(self, angle):
        """
        Initializes the Rotation class with a given angle.
